...
function update() {
	...
	function mousemove() {
		// we're using the invert method of an X scale here to find the time value that matches the coordinate position of our mouse (from version 6 is a pointer).
		const x0 = x.invert(d3.pointer(event)[0])
		// The basic date function is returning the index of our data array where this time value would belong if it was its own data point.
